...
tensor_normalizer = torchvision.transforms.Normalize(mean=cnn_normalization_mean, std=cnn_normalization_std)
epsilon = 1e-5
...
def preprocess_image(image, target_width=None):
    ...
    if target_width:
        t = torchvision.transforms.Compose([
            torchvision.transforms.Resize(target_width), 
            torchvision.transforms.CenterCrop(target_width), 
